...
<body>
  ...
  <div class="divcentro">
    <h1>SKA - São Leopoudo:</h1>
    <h1>Salas Disponíveis:</h1>
    <form action="calendario.php" method="POST">
      <input type="hidden" name="id" value="saoleopoudo_sala01">
      <button type="submit"  class="btn btn-outline-primary">Sala 1</button>
    </form>
    <p></p>
    <form class="" action="calendario.php" method="POST">
      <input type="hidden" name="id" value="saoleopoudo_sala02">
      <button type="submit"  class="btn btn-outline-primary">Sala 2</button>
    </form>
    <p></p>
    <form class="" action="calendario.php" method="POST">
      <input type="hidden" name="id" value="saoleopoudo_sala03">
      <button type="submit"  class="btn btn-outline-primary">Sala 3</button>
    </form>
    <p></p>
    <form class="" action="calendario.php" method="POST">
      <input type="hidden" name="id" value="saoleopoudo_sala04">
      <button type="submit"  class="btn btn-outline-primary">Sala 4</button>
    </form>
  </div>
